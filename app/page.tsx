  ...
  return (
    ...
    <div className="relative">
      <div className="isolate">
        <div className="flex flex-row justify-evenly pt-6 uppercase text-lg">
          <h1>History</h1>
          <h1>People</h1>
          <h1>Toledo</h1>
          <h1>Arc</h1>
      ...
      <div className="flex flex-col items-center justify-center pt-70 ">
          <p className="font-bold uppercase text-5xl">Enlist. Resist</p>
          <div className="text-justify py-2 px-170 text-balance">
